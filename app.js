...
var UIController = (() =>{
    ...
    let formatNumber = (num,type)=>{
        let numSplit;
        //+ or - before number, exactly 2 decimals, comma separating the thousands
        num = Math.abs(num);
        num = num.toFixed(2);
...
var controller = ((budgetCtrl, UICtrl) =>{
    ...
    var updatePercentages = ()=>{
        ...
        //3. update the ui wuhit the nuew percentages
    ...
    var ctrlAddItem = function() {
        ...
        if(input.description !=='' && !isNaN(input.value) && input.value > 0 ){
            ...
            // 2. Add the item to the bullet controller
    ...
    var ctrlDeleteItem = (event)=>{
        ...
        if(itemID) {
            ...
            // 1.Update and show the new budget
            updateBudget();
